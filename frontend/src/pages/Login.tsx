...
const handleSubmit = async (e: FormEvent) => {
  ...
  return (
    <div className="min-h-screen bg-[#06070f] flex items-center justify-center px-4 hero-grid">
      <div className="absolute top-20 left-1/3 w-72 h-72 bg-indigo-600/15 rounded-full blur-[80px]" />
      <div className="absolute bottom-20 right-1/3 w-56 h-56 bg-purple-600/15 rounded-full blur-[80px]" />
      ...
      <div className="w-full max-w-md relative animate-fade-in-up">
        ...
        <div className="glass-card p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 text-slate-300 rounded-xl py-3 px-4 hover:bg-white/10 transition-all mb-6 font-medium"
          >
